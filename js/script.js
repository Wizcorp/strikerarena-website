...
var content = {
	...
	'chooseSide': {
		...
		ru: 'Выбери на чьей ты стороне, сокруши врагов на Арене и стань новым Императором!'
	},
	'stayTuned': {
		...
		ru: 'Следите за обновлениями. <a href="mailto:striker.arena@wizcorp.jp">Обращайтесь к нам</a> чтобы узнать больше.'
	}
}
